...
[Command-T](https://wincent.com/products/command-t) 是一款很不错的 Vim 插件，该插件允许你在 Vim 中快速导航文件，以用于后续的编辑处理。
...
在下载 [Command-T](http://www.vim.org/scripts/script.php?script_id=3025) 后，你可以按如下的步骤来安装：
